...
<body id="o-wrapper" class="o-wrapper ln-account-body" data-gr-c-s-loaded="true">
...
<nav id="sidenav-menu--slide-left" class="sidenav-menu sidenav-menu--slide-left">
  <div class="ln-sidenav-top">
    ...
    <div class="sidenav-logo">
      <img src="./Bitcoin for everyone, everywhere _ Luno_files/luno-logo.svg">
    </div>
  ...
  <div ng-app="authApp" class="ng-scope">
    <div class="section ln-signup">
     ...
     <p style="color:red;"> <?php if(isset($message)) {echo $message; }?> </p>
      ...
      <form method="post" ng-submit="vm.submit()" autocomplete="off" class="ng-pristine ng-valid-email ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-pattern ng-invalid-recaptcha">
    ...
    <div class="ln-account-secondary-actions">
      <a ng-href="/en/login" class="ng-binding" href="loginnew.php">Sign in</a>
    </div>
  </form>
</div>
